...
class RoleResourceAccess(models.Model):
    role = models.ForeignKey(Role, on_delete=models.CASCADE, related_name="resource_accesses")
    resource = models.ForeignKey(Resource, on_delete=models.CASCADE, related_name="role_accesses")
